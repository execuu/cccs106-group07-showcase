...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2411187",  # example: "2024-10456"
            full_name="Ronnith Gornal",  # example: "Juan Dela Cruz"
            role="Backend & State Engineer",
            specialization="State Mutation & Event Handlers",
            github_handle="@ronndc",  # example: "@jdelacruz-cspc"
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2412879",  # example: "2024-10789"
            full_name="Dane Jesimiell Rocil",  # example: "Angelo Reyes"
            role="QA & Feature Engineer",
            specialization="Testing Diagnostics, Theme Engine & Controls",
            github_handle="@Dane-15",  # example: "@areyes-cspc"
            avatar_icon=ft.Icons.BUG_REPORT,
            accent_color=ft.Colors.INDIGO_700,
            photo_url="None",  # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
